...
export function Mission() {
  return (
    <section id="mission" className="py-16 bg-royal-dark">
      <div className="max-w-7xl mx-auto px-6">
        {/* Hands-On Learning & Mentorship Section - Now First */}
        <motion.div
        ...
        >
          ...
          <p className="text-lg text-royal-cream/80 max-w-3xl mx-auto mb-8">
            Our experienced mentors work one-on-one with students, providing personalized guidance and support to help them develop their skills in robotics and AI.
          </p>
          <div className="royal-card bg-royal-dark-2/60 border border-royal-cream/8 rounded-xl p-8 shadow-card-soft hover:shadow-card transition-all duration-300">
            <div className="relative w-full max-w-2xl mx-auto h-80 rounded-xl overflow-hidden shadow-card">
              <Image
                src="/assets/child.png"
                alt="Mentor tutoring a child in robotics and AI education"
                fill
                className="object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-royal-dark/20 via-transparent to-transparent"></div>
            </div>
            <p className="text-sm text-royal-cream/70 mt-4 italic">
              "Every child deserves access to quality STEM education and mentorship"
            </p>
          </div>
        </motion.div>
